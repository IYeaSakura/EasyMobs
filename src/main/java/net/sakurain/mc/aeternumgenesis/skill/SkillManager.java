...
import net.sakurain.mc.aeternumgenesis.skill.condition.*;
import net.sakurain.mc.aeternumgenesis.util.TemplateIdUtil;
import net.sakurain.mc.aeternumgenesis.skill.effect.*;
...
public class SkillManager {
    ...
    public void registerEffect(String type, Supplier<net.sakurain.mc.aeternumgenesis.skill.effect.SkillEffect> supplier) {
    ...
    public void sendActionBar(Player player, String text) {
        ...
        net.sakurain.mc.aeternumgenesis.util.MessageUtil.sendActionBar(player, text);
    }
