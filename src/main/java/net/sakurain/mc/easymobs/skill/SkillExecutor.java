...
import net.sakurain.mc.easymobs.skill.condition.ConditionParser;
import net.sakurain.mc.easymobs.skill.condition.SkillCondition;
...
public class SkillExecutor {
    ...
    public SkillExecutor(EasyMobsPlugin plugin, SkillEffectRegistry effectRegistry, SkillConditionRegistry conditionRegistry) {
        this.plugin = plugin;
